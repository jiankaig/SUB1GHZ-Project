/* Adopted from: https://forum.43oh.com/topic/10011-using-spi-and-energia-with-ws2812-leds/
...
//#endif
  ...
  #define SPIDIV     6                    // 48 MHz/6 gives 125 ns for each on bit in byte
  #define SPILONG    0b11111100           // 750 ns (acceptable "on" range 550 to 850 ns)
  #define SPISHORT   0b11100000           // 375 ns (acceptable "on" range 200 to 500 ns)

const unsigned int PIXELS = 30;           // Pixels in the strip
